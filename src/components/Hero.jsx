  ...
  return (
    <section className="relative isolate overflow-hidden">
      <div aria-hidden="true" className="absolute inset-x-0 -top-40 -z-10 transform-gpu blur-3xl">
        <div className="mx-auto aspect-[1155/678] w-[72rem] bg-gradient-to-tr from-brand-400 to-emerald-300 opacity-15 dark:opacity-20 [clip-path:polygon(74%_44%,100%_62%,97%_27%,85%_0%,80%_2%,72%_32%,60%_62%,52%_68%,47%_58%,45%_35%,27%_76%,0%_65%,18%_100%,27%_77%,76%_98%)]" />
      </div>
      ...
      <div className="container-page py-28 sm:py-36">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-8 max-w-3xl text-xl text-pretty text-slate-600 sm:text-2xl/9 dark:text-slate-400">
            {site.positioning}
          </p>
