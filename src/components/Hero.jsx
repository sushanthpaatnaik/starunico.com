      ...
      <div className="container-page py-28 sm:py-36">
        <div className="max-w-4xl">
          <p className="meta flex flex-wrap items-baseline gap-x-3">
            ...
            <span aria-hidden="true" className="text-panel-ink/70">
              /
            </span>
            <span className="text-accent">Proprietary deep-tech investing</span>
          </p>
          ...
          <p className="mt-10 max-w-2xl text-xl text-pretty text-ink-2 sm:text-2xl/9">
            {site.positioning}
          </p>
